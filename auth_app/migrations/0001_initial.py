# Generated by Django 4.1.5 on 2023-06-15 15:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('salt_value', models.CharField(max_length=128)),
            ],
        ),
        migrations.CreateModel(
            name='Sysadmin',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('passwd', models.CharField(max_length=128, unique=True)),
                ...
                ('salt', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='servidores', to='auth_app.salt')),
                ('sysadmin', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='servidores', to='auth_app.sysadmin')),
            ],
        ),
        migrations.CreateModel(
            name='AdmonGlobal',
